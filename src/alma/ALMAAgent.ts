...
export class ALMAAgent {
  ...
  evaluateDesign(
    ...
    `);
    const best = bestStmt.get() as any;
   ...
   */
  getTopDesigns(k: number = 5): MemoryDesign[] {
    const stmt = this.db.prepare(`
   ...
   */
  private mutateParameters(baseParams: MemoryDesignParams): MemoryDesignParams {
   ...
   */
  private createRandomParameters(): MemoryDesignParams {
    const params: MemoryDesignParams = {};
